...
- IMAGE STYLE: this account posts news/tool roundups, not fiction — the image prompt should describe
  a clean PRESENTATION/INFOGRAPHIC/DASHBOARD style (dark tech-dashboard aesthetic, clean on-image text
  labels, small icons, short callout boxes, a clear header title), not a hyper-realistic cinematic
  render. Explicitly include what short text/labels should appear (a title + 2-4 short labels naming
  the tools/items covered) since modern AI image tools (Gemini/Nano Banana, ChatGPT/GPT Image, etc.)
  render text well now — don't leave the image wordless.
