...
- If one of the kept items would genuinely benefit from a visual (e.g. a UI/design tool, something
  visually striking), set needs_image true and write one image prompt for it. Otherwise false and "".
...
def send_roundup_to_telegram(items, roundup_data):
    ...
    if roundup_data.get("needs_image") and roundup_data.get("image_prompt"):
